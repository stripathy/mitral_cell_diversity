function globParms = setupfitting_GLMbi(gg, Stim, maxsize);
...
globParms.OPRS = OPRS;
globParms.SPNDS = SPNDS;
globParms.SPNDS2 = SPNDS2;
globParms.MSP = MSP;
globParms.MSTM = MSTM;
globParms.MMntrp = MMntrp;
globParms.RefreshRate = gg.RefreshRate;

function [] = greedySearchRealSpikes(objFxnInd, stimInd)

%% code to run greedy search on best pops vs stims

% load data - stim and spike trains over neurons
% and KP's injected stimuli
load 'realSpikesFormatted1';

% only use neurons which received common stimulus
neuronsToSim = keepCells(29:44);

...
% Outputs: xcorrs- matrix of numCells x corrTPts, where each vector is the
% trial to trial cross correlation across trials for a given cell
% acorrs1 and 2- these are the autos for xcorrs
% xcorrrsPairwise- matrix of (numCells*numCells) x corrTPts, where each
% vector is the mean crosscorr of all trials for 1 cell to all trials of
% another
% autocorrs- matrix of numcellsx corrTPts with the autocorrs for each cell

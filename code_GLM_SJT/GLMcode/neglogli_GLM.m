...
% SPNDS = globParms.SPNDS;
% SPNDS2 = globParms.SPNDS2;
% RefreshRate = globParms.RefreshRate;
RefreshRate = gg.RefreshRate;
[SPNDS SPNDS2 MSP] = setSPNDS(gg);  % set global vars
...
if ~isempty(ih)
    ihComp = spikeconv_mex(SPNDS,ih(:,1),[1,rlen]);
    Iinj = Iinj + ihComp;
    for j = 1:nCoupled
